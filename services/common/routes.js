...
export const ONEMAC_ROUTES = {
  ...
  MEDICAID_SPA_SUBSEQUENT_SUBMSISSION: "/medicaid-spa-subsequent-submission",
  CHIP_SPA: "/chip-spa",
  CHIP_SPA_DETAIL: "/detail/chip-spa",
  CHIP_SPA_RAI: "/chip-spa-rai",
  CHIP_SPA_WITHDRAW: "/chip-spa-withdraw",
  CHIP_SPA_SUBSEQUENT_SUBMSISSION: "/chip-spa-subsequent-submission",
  ...
  INITIAL_WAIVER_SUBSEQUENT_SUBMSISSION:
    "/initial-waiver-subsequent-submission",
  ...
  WAIVER_RENEWAL_SUBSEQUENT_SUBMSISSION:
    "/waiver-renewal-subsequent-submission",
  ...
  WAIVER_AMENDMENT_SUBSEQUENT_SUBMSISSION:
    "/waiver-amendment-subsequent-submission",
  ...
  WAIVER_APP_K_SUBSEQUENT_SUBMSISSION: "/waiver-app-k-subsequent-submission",
