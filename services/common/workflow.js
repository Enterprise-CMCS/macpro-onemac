...
export const ACTIONS = {
  [TYPE.CHIP_SPA]: defaultActionsByStatus,
  [TYPE.CHIP_SPA_RAI]: raiActionsByStatus,
  [TYPE.SPA]: defaultActionsByStatus,
  [TYPE.SPA_RAI]: raiActionsByStatus,
  [TYPE.WAIVER]: defaultActionsByStatus,
  [TYPE.WAIVER_RAI]: raiActionsByStatus,
  [TYPE.WAIVER_BASE]: defaultActionsByStatus,
  [TYPE.WAIVER_RENEWAL]: defaultActionsByStatus,
  [TYPE.WAIVER_AMENDMENT]: defaultActionsByStatus,
  [TYPE.WAIVER_EXTENSION]: defaultActionsByStatus,
  [TYPE.WAIVER_APP_K]: defaultActionsByStatus,
};
