class WaiverEmailTemplates extends DefaultEmailTemplates {
    ...
    <p>Files:</p>
    <p>${super.getLinksHtml(data.uploads)}</p>
    <p>You can expect a formal response to your submission to be issued within 90 days, 
    on ${super.get90thDay(data.createdDate)}. If you have any questions, please contact spa@cms.hhs.gov or your state lead.</p>
    `;
    }
