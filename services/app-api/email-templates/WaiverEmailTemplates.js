  ...
  getCMSEmail(data) {
    ...
    cmsEmail.HTML = `
        ...
        <p>
            ...
            <br><b>90th day deadline</b>: ${get90thDay(data.createdAt)}
        </p>
        <p>
            <b>Summary</b>:
            <br>${data.summary}
  ...
  getStateEmail(data) {
    ...
    stateEmail.HTML = `
        ...
        <p>
            ...
            You can expect a formal response to your submittal to be issued within 90 days, before ${get90thDay(data.createdAt)}.
        </p>
        <p>
