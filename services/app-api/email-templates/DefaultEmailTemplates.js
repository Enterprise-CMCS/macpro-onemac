...
class DefaultEmailTemplates {
    constructor(){
        if(! DefaultEmailTemplates.instance){
            DefaultEmailTemplates.instance = this;
        }

        return DefaultEmailTemplates.instance;
    }
    ...
    getStateEmail(data) {
        ...
        stateEmail.ToAddresses = [data.email];
...
const instance = new DefaultEmailTemplates();
