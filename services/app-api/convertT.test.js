...
beforeAll(() => {
  ...
  dynamoDb.scan.mockImplementation(() => {
    return {
      Items: [
        {
          summary:
            "This is anamendment for the renewal MI.1122.R01 for the base MI.1122",
          ...
          uploads: [
            {
              ...
              title:
                "1915(b) Comprehensve (Capitated) Waiver Application Pre-print (Initial, Renewal, Amendment)",
  ...
  validateSubmission.mockResolvedValue(() => {
    return null;
  });
});
