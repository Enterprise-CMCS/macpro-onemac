import {
  main,
  waiverRenewalB4FormConifg,
  waiverRenewalBFormConifg,
} from "./submitWaiverRenewal";
...
describe("main", () => {
  it("should submit renewal waiver B4 form", async () => {
    const data = {
    ...
    expect(submitAny).toHaveBeenCalledWith(event, waiverRenewalB4FormConifg);
  });

  it("should submit renewal waiver B form", async () => {
    const data = {
    ...
    expect(submitAny).toHaveBeenCalledWith(event, waiverRenewalBFormConifg);
  });
