...
export default function PopupMenu({selectedRow}) {
    ...
    return (
        <>
            ...
            >
                ...
                <MenuItem className={classes.root} onClick={handleClose}>Approve Access</MenuItem>
                <hr/>
                <MenuItem className={classes.root} onClick={handleClose}>Deny Access</MenuItem>
            </Menu>
        </>
    );
}
