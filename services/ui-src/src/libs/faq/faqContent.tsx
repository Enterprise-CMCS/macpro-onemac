  ...
  },
  {
    ...
    qanda: [
      ...
      },
      {
        ...
        isOpen: false,
        question:
          "What State Plan Amendments (SPAs) can be submitted to OneMAC",
        isMmdl: true,
        answerJSX: (
          <div>
            <p>
              OneMAC is the electronic submission system for all paper-based
              Medicaid and Children's Health insurance Program (CHIP) SPAs.
            </p>
            <p>
              Starting [TBD], CMS is modifying the state transmittal process for
              Medicaid. Alternative Benefit Plan SPAs, Medicaid Premium and Cost
              Sharing SPAs, and CHIP Eligibility SPAs which were previously
              submitted to CMS through Medicaid Model Data Lab (MMDL).
            </p>
            <p>
              In order to be processed, States will need to submit these state
              actions to the OneMAC system. The MMDL system will no longer
              accept new submissions for these SPA actions.
            </p>
            <p>
              MMDL SPA submissions submitted prior to [TBD], including those SPA
              actions currently off the clock with a Request for Additional
              Information; will continue to be processed through the MMDL
              system. However, no new submissions or amendments will be accepted
              in the MMDL system.
            </p>
            <p>
              Medicaid Alternative Benefit SPAs, Premium and Cost Sharing SPAs,
              and CHIP Eligibility SPAs will continue to use the published SPA
              templates and Implementation Guides which can now be found
              here/below. This change does not apply to electronic Medicaid SPA
              submissions processed in the Medicaid and CHIP Program Portal
              (MACPro) system.
            </p>
          </div>
        ),
          ...
          <>
            <ul className="file-type-list">
              {[
                ...
                [
                  "ABP3.pdf",
                  "ABP 3: Selection of Benchmark Benefit Package or Benchmark-Equivalent Benefit Package Use only if ABP has an effective date earlier than 1/1/2020 or if only changing the Section 1937 Coverage Option of an ABP implemented before 1/1/2020",
                ],
                [
                  "ABP3.1.pdf",
                  "ABP 3.1: Selection of Benchmark Benefit or Benchmark-Equivalent Benefit Package Use only for ABP's effective on or after 1/1/2020",
                ],
                ...
                [
                  "ABP9.pdf",
                  "ABP 9: Employer-Sponsored Insurance and Payment of Premiums",
                ],
                ["ABP10.pdf", "ABP 10: General Assurances"],
                ["ABP11.pdf", "ABP 11: Payment Methodology"],
              ].map(([filename, label]) =>
                !label.includes("or Benchmark-Equivalent Benefit Package") &&
                !label.includes("3.1") ? (
                  <li key={filename}>
                    <a
        ...
        answerJSX: (
          <>
            <ul className="file-type-list">
              {[
                [
                  "IG_ABP1_AlternativeBenefitPlanPopulations.doc",
                  "ABP 1: Alternative Benefit Plan Populations Implementation Guide",
                ],
                [
                  "IG_ABP2a_VoluntaryBenefitPackageAssurances.doc",
                  "ABP 2a: Voluntary Benefit Package Selection Assurances - Eligibility Group under Section 1902(a)(10)(A)(i)(VIII) of the Act Implementation Guide",
                ],
                [
                  "IG_ABP2b_VoluntaryEnrollmentAssurances.doc",
                  "ABP 2b: Voluntary Enrollment Assurances for Eligibility Groups other than the Adult Group under Section 1902(a)(10)(A)(i)(VIII) of the Act Implementation Guide",
                ],
                [
                  "IG_ABP3_SelectionOfBenchmark.doc",
                  "ABP 3: Selection of Benchmark Benefit Package or Benchmark-Equivalent Benefit Package Implementation Guide",
                ],
                [
                  "IG_ABP3.1_SelectionOfBenchmark20190819-Final.docx",
                  "ABP 3.1: Selection of Benchmark Benefit Package or Benchmark-Equivalent Benefit Package Implementation Guide",
                ],
                [
                  "IG_ABP4_AbpCostSharing.doc",
                  "ABP 4: Alternative Benefit Plan Cost Sharing Implementation Guide",
                ],
                [
                  "IG_ABP5_BenefitsDescription-Final.docx",
                  "ABP 5: Benefits Description Implementation Guide",
                ],
                [
                  "IG_ABP6_BenchmarkEquivalentBenefit.doc",
                  "ABP 6: Benchmark-Equivalent Benefit Package Implementation Guide",
                ],
                [
                  "IG_ABP7_BenefitAssurances.doc",
                  "ABP 7: Benefit Assurances Implementation Guide",
                ],
                [
                  "IG_ABP8_ServiceDeliverySystems.doc",
                  "ABP 8:Service Delivery Systems Implementation Guide",
                ],
                [
                  "IG_ABP9_EmployerSponsoredInsurance.doc",
                  "ABP 9: Employer-Sponsored Insurance and Payment of Premiums Implementation Guide",
                ],
                [
                  "IG_ABP10_GeneralAssurances.doc",
                  "ABP 10: General Assurances Implementation Guide",
                ],
                [
                  "IG_ABP11_PaymentMethodology.doc",
                  "ABP 11: Payment Methodology Implementation Guide",
                ],
              ].map(([filename, label]) => (
                <li key={filename}>
                  <a
        ...
        answerJSX: (
          <>
            <ul className="file-type-list">
              {[
                [
                  "IG_G1_CostSharingRequirements.doc",
                  "G 1: Cost-Sharing Requirements Implementation Guide",
                ],
                [
                  "IG_G2a_CostSharingAmountsCN.doc",
                  "Cost Sharing Amounts - Categorically Needy Implementation Guide",
                ],
                [
                  "IG_G2b_CostSharingAmountsMN.doc",
                  "Cost Sharing Amounts - Medically Needy Implementation Guide",
                ],
                [
                  "IG_G2c_CostSharingAmountsTargeting.doc",
                  "Cost Sharing Amounts - Targeting Implementation Guide",
                ],
                [
                  "IG_G3_CostSharingLimitations.doc",
                  "Cost Sharing Limitations Implementation Guide",
                ],
              ].map(([filename, label]) => (
                <li key={filename}>
                  <a
      ...
      },
      {
        ...
        isOpen: false,
        isMmdl: true,
        question: "Where can I download CHIP SPA PDFs?",
        answerJSX: (
          <>
            ...
            <ul className="file-type-list">
              {[
                ...
                [
                  "CS8.pdf",
                  "CS 8: Eligibility - Targeted Low-Income Pregnant Women",
                ],
                [
                  "CS9.pdf",
                  "CS 9: Eligibility - Coverage From Conception to Birth",
                ],
                [
                  "CS10.pdf",
                  "CS 10: Eligibility - Children Who Have Access to Public Employee Coverage",
                ],
                [
                  "CS11.pdf",
                  "CS 11: Eligibility - Pregnant Women Who Have Access to Public Employee Coverage",
                ],
                [
                  "CS12.pdf",
                  "CS 12: Eligibility - Dental Only Supplemental Coverage",
                ],
            ...
            <a
              ...
              className="spa-link"
            >
              "CS 14: Eligibility - Children Ineligible for Medicaid as a Result
              of the Elimination of Income Disregards"
            </a>
      ...
      },
      {
        ...
        isOpen: false,
        isMmdl: true,
        question: "Where can I download CHIP SPA implementation guides?",
        answerJSX: (
          <>
            <h4>MAGI Eligibility & Methods</h4>
            <ul className="file-type-list">
              {[
                [
                  "IG_CS7_TargetedLow-IncomeChildren.doc",
                  "CS 7: Eligibility - Targeted Low-Income Children Implementation Guide",
                ],
                [
                  "IG_CS8_TargetedLow-IncomePregnantWomen.doc",
                  "CS 8: Eligibility - Targeted Low-Income Pregnant Women Implementation Guide",
                ],
                [
                  "IG_CS9_CoverageFromConceptionToBirth.doc",
                  "CS 9: Eligibility - Coverage From Conception to Birth Implementation Guide",
                ],
                [
                  "IG_CS10_ChildrenWhoHaveAccessToPublicEmployeeCoverage.doc",
                  "CS 10: Eligibility - Children Who Have Access to Public Employee Coverage Implementation Guide",
                ],
                [
                  "IG_CS11_PregnantWomenWhoHaveAccessToPublicEmployeeCoverage.doc",
                  "CS 11: Eligibility - Pregnant Women Who Have Access to Public Employee Coverage Implementation Guide",
                ],
                [
                  "IG_CS12_DentalOnlySupplementalCoverage.doc",
                  "CS 12: Eligibility - Dental Only Supplemental Coverage Implementation Guide",
                ],
                [
                  "IG_CS13_DeemedNewborns.doc",
                  "CS 13: Eligibility - Deemed Newborns Implementation Guide",
                ],
                [
                  "IG_CS15_MAGI-BasedIncomeMethodologies.doc",
                  "CS 15: MAGI-Based Income Methodologies Implementation Guide",
                ],
                [
                  "IG_CS16_Spenddown.doc",
                  "CS 16: Other Eligibility Criteria - Spenddowns Implementation Guide",
                ],
              ].map(([filename, label]) => (
                <li key={filename}>
                  <a
            ...
            <a
              ...
              download
            >
              CS 3: Eligibility for Medicaid Expansion Program Implementation
              Guide
            </a>
            <h4>Establish 2101(f) Groups</h4>
            <a
            ...
            >
              CS 14: Eligibility - Children Ineligible for Medicaid as a Result
              of the Elimination of Income Disregards Implementation Guide
            </a>
            <h4>Eligibility Processing</h4>
            <a
              ...
              download
            >
              CS 24: General Eligibility - Eligibility Processing Implementation
              Guide
            </a>
            <h4>Non-Financial Eligibility</h4>
            <ul className="file-type-list">
              {[
                [
                  "IG_CS17_Non-Financial-Residency.doc",
                  "CS 17: Non-Financial Eligibility - Residency Implementation Guide",
                ],
                [
                  "IG_CS18_Non-Financial-Citizenship.doc",
                  "CS 18: Non-Financial Eligibility - Citizenship Implementation Guide",
                ],
                [
                  "IG_CS19_Non-Financial-SocialSecurityNumber.doc",
                  "CS 19: Non-Financial Eligibility - Social Security Number Implementation Guide",
                ],
                [
                  "IG_CS20_Non-Financial-SubstitutionOfCoverage.doc",
                  "CS 20: Non-Financial Eligibility - Substitution of Coverage Implementation Guide",
                ],
                [
                  "IG_CS21_NonFinancialNonPaymentOfPremiums.doc",
                  "CS 21: Non-Financial Eligibility - Non-Payment of Premiums Implementation Guide",
                ],
                [
                  "IG_CS23_NonFinancialRequirementOtherEligibilityStandards.doc",
                  "CS 23: Non-Financial Requirements - Other Eligibility Standards Implementation Guide",
                ],
                [
                  "IG_CS27_ContinuousEligibility.doc",
                  "CS 27: General Eligibility - Continuous Eligibility Implementation Guide",
                ],
                [
                  "IG_CS28_PresumptiveEligibilityForChildren.doc",
                  "CS 28: General Eligibility - Presumptive Eligibility for Children Implementation Guide",
                ],
                [
                  "IG_CS29_PresumptiveEligibilityForPregnantWomen.doc",
                  "CS 29: General Eligibility - Presumptive Eligibility for Pregnant Women Implementation Guide",
                ],
              ].map(([filename, label]) => (
                <li key={filename}>
                  <a
