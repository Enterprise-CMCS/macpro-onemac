...
import WaiverAppendixKRAIForm from "./WaiverAppendixKRAIForm";
...
describe("Waiver Appendix K RAI Form", () => {
  let history;

  const testComponentId = "MD-13150.R00.01";

  beforeEach(() => {
    history = createMemoryHistory();
    history.push(ONEMAC_ROUTES.WAIVER_APP_K_RAI, {
