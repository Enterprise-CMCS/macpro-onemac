Feature: Subsequent Submission 1915b Waiver Amendment
    ...
    Scenario: Screen Enhance
        ...
        Then verify the form title is "Upload Subsequent Waiver Amendment Documentation"
        Then verify the form header is "Waiver Amendment Subsequent Submission Details"
