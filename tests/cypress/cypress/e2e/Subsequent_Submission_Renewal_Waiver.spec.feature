Feature: Subsequent Submission 1915b Renewal Waiver
    ...
    Scenario: Screen Enhance
        ...
        Then verify the form title is "Upload Subsequent Waiver Renewal Documentation"
        Then verify the form header is "Waiver Renewal Subsequent Submission Details"
