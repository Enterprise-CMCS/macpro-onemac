Feature: Verify user can withdraw a package in Under Review Status in the package dashboard 
    ...
    Scenario: Screen Enhance - Validate Renewal Waiver Withdrawal Page from the dashboard
        ...
        Then verify Form Intro Text is "Complete this action to withdraw this 1915(b) Waiver Renewal package. Once completed, you will not be able to resubmit the 1915(b) Waiver Renewal package or undo this action."
        Then verify ID Label is "1915(b) Waiver Renewal Number"
