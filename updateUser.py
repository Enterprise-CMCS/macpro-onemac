...
if (len(sys.argv) > 4) :
  ...
  f = open("user.json", "w")
  f.write("{ \"id\": { \"S\": \"" + userId + "\" }, \"type\": { \"S\": \"" + role + "\" }, \"attributes\": { \"L\": [ { \"M\" : { \"date\" : { \"N\" : \"1617983752\" }, \"doneBy\" : { \"S\" : \"zlewis@clarityinnovates.com\" }, \"status\" : { \"S\" : \"active\" } , \"history\" : { \"L\": [ { \"M\" : { \"date\" : { \"N\" : \"1617983752\" }, \"doneBy\" : { \"S\" : \"zlewis@clarityinnovates.com\" }, \"status\" : { \"S\" : \"active\" } } }, { \"M\" : { \"date\" : { \"N\" : \"1617985441\" }, \"doneBy\" : { \"S\" : \"zlewis@clarityinnovates.com\" }, \"status\" : { \"S\" : \"active\" } }} ] }, \"stateCode\" : { \"S\" : \"MI\" } }}]} }")
  f.close()
