...
(function () {
    function initTestCafeUI(window) {
        ...
        (function (hammerhead, testCafeCore) {
    ...
    ***************************************************************************** */
    ...
    var StatusBar = /** @class */ (function (_super) {
        ...
        StatusBar.prototype._bindHandlers = function () {
            ...
            listeners$1.addInternalEventListener(window, ['resize'], function () {
                _this.windowHeight = window.innerHeight;
            });
            var statusBarHeight = styleUtils$6.getHeight(this.statusBar);
            listeners$1.addFirstInternalHandler(window, ['mousemove', 'mouseout', 'touchmove'], function (e) {
        ...
        StatusBar.prototype._bindClickOnce = function (elements, handler) {
            ...
            var downHandler = function (e) {
                ...
                if (isTargetElement) {
                    ...
                    listeners$1.removeInternalEventListener(window, [eventName], downHandler);
                    handler(e);
                }
                else if (domUtils$1.containsElement(_this.statusBar, e.target))
                    eventUtils$2.preventDefault(e);
            };
            listeners$1.addInternalEventListener(window, [eventName], downHandler);
        };
...
}(window['%hammerhead%'], window['%testCafeCore%']));
