// This test is inconsistently failing- commented out until we decide what to do with it
...
//         browser.click("xpath", "//a[@id='userManagementLink']").pause(4000);
...
//         browser.useCss();
//         browser.click("xpath", "//button[@id='new-submission-button']");
//         browser.click("xpath", "//td[@id='transmittalNumber-0']" );
