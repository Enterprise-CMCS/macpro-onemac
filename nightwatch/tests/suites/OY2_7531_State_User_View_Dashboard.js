...
module.exports = {
    ...
    'User can see their state access management': function (browser) {
        ...
        let california = "(//div[@class='state-access-card']/dt)[2]";
        let california_access_granted = "(//div[@class='state-access-card']/dd/em)[2]";
        let virginia = "(//div[@class='state-access-card']/dt)[3]";
        let virginia_pending_access = "(//div[@class='state-access-card']/dd/em)[3]";
        ...
        browser.useXpath().expect.element(california).to.be.visible;
        browser.useXpath().expect.element(california_access_granted).to.be.visible;
        browser.useXpath().expect.element(virginia).to.be.visible;
        browser.useXpath().expect.element(virginia_pending_access).to.be.visible;
        browser.useCss();
